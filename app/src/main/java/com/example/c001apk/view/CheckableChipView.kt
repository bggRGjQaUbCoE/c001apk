...
class CheckableChipView @JvmOverloads constructor(
    ...
    init {
        ...
        context.withStyledAttributes(
            ...
            textSize =
                getDimension(
                    R.styleable.CheckableChipView_android_textSize,
                    TextView(context).textSize
                )
    ...
    private fun createLayout(textWidth: Int) {
        val alignment =
            if (Bidi(text.toString(), Bidi.DIRECTION_DEFAULT_LEFT_TO_RIGHT).isRightToLeft) {
